<div class="about-us-container" style="padding: clamp(80px, 15vh, 140px) 0 100px; min-height: 100vh; background: radial-gradient(circle at 50% -20%, #2a0e14 0%, #0b0c10 70%); overflow: hidden; position: relative;">
    <!-- Abstract Background Elements -->
    <div style="position: absolute; top: 10%; left: -5%; width: 400px; height: 400px; background: radial-gradient(circle, var(--primary-transparent) 0%, transparent 70%); filter: blur(60px); opacity: 0.5; pointer-events: none;"></div>
    <div style="position: absolute; bottom: 10%; right: -5%; width: 500px; height: 500px; background: radial-gradient(circle, rgba(217, 4, 41, 0.05) 0%, transparent 70%); filter: blur(80px); opacity: 0.4; pointer-events: none;"></div>
        ...
        <div class="about-grid" style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 60px; align-items: center; margin-bottom: 140px; position: relative; z-index: 2;">
            <div class="fade-up visible story-text-col" style="transition-delay: 0.1s;">
                ...
                <div class="story-p-container" style="display: flex; flex-direction: column; gap: 24px;">
                    ...
                    <p style="font-size: 1.15rem; line-height: 1.8; color: var(--text-secondary);">
                        Our philosophy is simple: <strong style="color: var(--primary);">Software shouldn't feel like work.</strong> It should be an extension of your business that automates the boring parts, so you can focus on building your community.
                    </p>
                    <div style="display: flex; gap: 20px; margin-top: 16px;">
                        <div style="padding: 16px 24px; background: var(--glass-bg); border: 1px solid var(--glass-border); border-radius: 16px;">
                            <div style="color: var(--primary); font-weight: 800; font-size: 1.5rem; margin-bottom: 4px;">2026</div>
                            <div style="color: var(--text-secondary); font-size: 0.85rem; text-transform: uppercase; letter-spacing: 1px;">Established</div>
                        </div>
                        <div style="padding: 16px 24px; background: var(--glass-bg); border: 1px solid var(--glass-border); border-radius: 16px;">
                            <div style="color: var(--primary); font-weight: 800; font-size: 1.5rem; margin-bottom: 4px;">Sialkot</div>
                            <div style="color: var(--text-secondary); font-size: 0.85rem; text-transform: uppercase; letter-spacing: 1px;">HQ Location</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="fade-up visible" style="transition-delay: 0.3s;">
                <div style="background: #0d0e12; border: 1px solid var(--glass-border); border-radius: 24px; overflow: hidden; box-shadow: 0 40px 100px rgba(0,0,0,0.6); position: relative;">
                    <!-- Top Gradient Accent -->
                    <div style="height: 4px; width: 100%; background: linear-gradient(90deg, transparent, var(--primary), transparent);"></div>
                    
                    <div style="padding: 40px 30px; text-align: center;">
                        <div style="position: relative; width: 140px; height: 140px; margin: 0 auto 24px;">
                            <div style="position: absolute; inset: -4px; border-radius: 50%; background: linear-gradient(45deg, var(--primary), transparent); animation: rotate 4s linear infinite; opacity: 0.6;"></div>
                            <img src="/FaizanMasood-Founder.jpeg" alt="Faizan Butt" style="width: 100%; height: 100%; border-radius: 50%; object-fit: cover; border: 4px solid #0d0e12; position: relative; z-index: 1;">
                            <div style="position: absolute; bottom: 8px; right: 8px; width: 22px; height: 22px; background: #4ade80; border: 4px solid #0d0e12; border-radius: 50%; z-index: 2; box-shadow: 0 0 15px rgba(74, 222, 128, 0.4);"></div>
                        </div>
                        
                        <h3 style="font-size: 1.5rem; margin-bottom: 4px; font-weight: 700;">Faizan Butt</h3>
                        <div style="color: var(--primary); font-size: 0.75rem; font-weight: 800; text-transform: uppercase; letter-spacing: 2px; margin-bottom: 24px;">Founder & CEO</div>
                        
                        <div style="display: flex; flex-direction: column; gap: 10px; margin-bottom: 24px;">
                            <div style="display: flex; justify-content: space-between; align-items: center; padding: 8px 14px; background: rgba(255,255,255,0.03); border-radius: 10px; border: 1px solid rgba(255,255,255,0.05);">
                                <span style="color: var(--text-secondary); font-size: 0.8rem;">Role</span>
                                <span style="color: #fff; font-size: 0.8rem; font-weight: 600;">Fullstack Developer</span>
                            </div>
                            <div style="display: flex; justify-content: space-between; align-items: center; padding: 8px 14px; background: rgba(255,255,255,0.03); border-radius: 10px; border: 1px solid rgba(255,255,255,0.05);">
                                <span style="color: var(--text-secondary); font-size: 0.8rem;">Tech Stack</span>
                                <span style="color: #fff; font-size: 0.8rem; font-weight: 600;">MERN + Laravel</span>
                            </div>
                            <div style="display: flex; justify-content: space-between; align-items: center; padding: 8px 14px; background: rgba(255,255,255,0.03); border-radius: 10px; border: 1px solid rgba(255,255,255,0.05);">
                                <span style="color: var(--text-secondary); font-size: 0.8rem;">Active Clients</span>
                                <span style="color: #fff; font-size: 0.8rem; font-weight: 600;">100+ Served</span>
                            </div>
                            <div style="display: flex; justify-content: space-between; align-items: center; padding: 8px 14px; background: rgba(255,255,255,0.03); border-radius: 10px; border: 1px solid rgba(255,255,255,0.05);">
                                <span style="color: var(--text-secondary); font-size: 0.8rem;">Satisfaction</span>
                                <span style="color: #4ade80; font-size: 0.8rem; font-weight: 600;">99.9% Rate</span>
                            </div>
                        </div>

                        <div style="display: flex; justify-content: center; gap: 12px;">
                            <a href="mailto:faizanbutt15@yahoo.com" style="width: 38px; height: 38px; display: flex; align-items: center; justify-content: center; background: rgba(255,255,255,0.05); border-radius: 50%; border: 1px solid var(--glass-border); transition: 0.3s; color: var(--text-secondary);" onmouseover="this.style.color='var(--primary)'; this.style.borderColor='var(--primary)'" onmouseout="this.style.color='var(--text-secondary)'; this.style.borderColor='var(--glass-border)'">
        ...
        <div style="text-align: center; margin-bottom: 60px;" class="fade-up visible">
            ...
            <div class="values-grid-about" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 40px;">
                <div style="background: rgba(255,255,255,0.01); padding: 50px 40px; border-radius: 32px; border: 1px solid var(--glass-border); transition: 0.4s; position: relative; overflow: hidden;" onmouseover="this.style.background='rgba(255,255,255,0.03)'; this.style.transform='translateY(-10px)'" onmouseout="this.style.background='rgba(255,255,255,0.01)'; this.style.transform='translateY(0)'">
                    ...
                    <h3 style="margin-bottom: 18px; font-size: 1.4rem;">Extreme Simplicity</h3>
                    <p style="color: var(--text-secondary); line-height: 1.7; font-size: 1rem;">We reduce complexity until only the essentials remain. Our software works for you, not the other way around.</p>
                </div>
                
                <div style="background: rgba(255,255,255,0.01); padding: 50px 40px; border-radius: 32px; border: 1px solid var(--glass-border); transition: 0.4s;" onmouseover="this.style.background='rgba(255,255,255,0.03)'; this.style.transform='translateY(-10px)'" onmouseout="this.style.background='rgba(255,255,255,0.01)'; this.style.transform='translateY(0)'">
                    <div style="width: 64px; height: 64px; background: var(--primary-transparent); border-radius: 18px; display: flex; align-items: center; justify-content: center; color: var(--primary); margin: 0 auto 32px;">
                    ...
                    <h3 style="margin-bottom: 18px; font-size: 1.4rem;">Unwavering Trust</h3>
                    <p style="color: var(--text-secondary); line-height: 1.7; font-size: 1rem;">Your business data is sacred. We use high-tier encryption and redundant servers to ensure you are always online.</p>
                </div>

                <div style="background: rgba(255,255,255,0.01); padding: 50px 40px; border-radius: 32px; border: 1px solid var(--glass-border); transition: 0.4s;" onmouseover="this.style.background='rgba(255,255,255,0.03)'; this.style.transform='translateY(-10px)'" onmouseout="this.style.background='rgba(255,255,255,0.01)'; this.style.transform='translateY(0)'">
                    <div style="width: 64px; height: 64px; background: var(--primary-transparent); border-radius: 18px; display: flex; align-items: center; justify-content: center; color: var(--primary); margin: 0 auto 32px;">
                        <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M23 6l-9.5 9.5-5-5L1 18"></path><polyline points="17 6 23 6 23 12"></polyline></svg>
                    </div>
                    <h3 style="margin-bottom: 18px; font-size: 1.4rem;">Constant Innovation</h3>
                    <p style="color: var(--text-secondary); line-height: 1.7; font-size: 1rem;">The industry doesn't stop, neither do we. We ship updates consistently to keep your gym at the cutting edge.</p>
                </div>
            </div>
        </div>
    </div>
